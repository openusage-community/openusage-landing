...
export const demoProviders: DemoProvider[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { type: "progress", label: "Weekly", used: 58, limit: 100, suffix: "%", color: "#111827", resets: "resets Sunday" },
    ],
    detail: [
      { type: "text", label: "Today", value: "18 long-context prompts" },
      { type: "text", label: "Best use", value: "research and document review" },
      { type: "badge", label: "Pace", value: "Healthy", color: "#16A34A" },
    ],
  },
  {
    id: "perplexity",
