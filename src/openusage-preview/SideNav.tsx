...
export function SideNav({ activeView, onViewChange, plugins, isDark }: SideNavProps) {
  return (
    <nav className="flex flex-col w-12 border-r bg-muted/50 dark:bg-card py-3">
      ...
      <NavButton
        isActive={false}
        onClick={() => window.open("https://github.com/openusage-community/openusage/issues", "_blank", "noopener,noreferrer")}
        aria-label="Help"
      >
